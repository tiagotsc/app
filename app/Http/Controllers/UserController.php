...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Wallet::create(['balance' => 100,'user_id' => $data->id]);
    ...
    /**
     * Trás dados de um único registro ou não
     */
    ...
    public function allDataJson()
    {
        $datas = DB::table('users as u')
                ->select('id', 'name', 'active', DB::raw('(SELECT COUNT(*) FROM model_has_roles m WHERE m.model_id = u.id) roles'))
                ->get();
